...
<head>
	...
	<title>Login &mdash; SMA 1 Pangkalan Kerinci {{ config('app.name') }}</title>
	...
	<link rel="shortcut icon" href="../assets/img/unsplash/logo_sma1.png" type="image/x-icon">
</head>
		...
		<section class="section">
			<div class="d-flex flex-wrap align-items-stretch">
				<div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
					<div class="p-4 m-3">
						<img src="../assets/img/unsplash/logo_sma1.png" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
						...
						<div class="text-center mt-5 text-small">
                            Copyright &copy; Inven-SMAIS. Made with 💙 by Us
                        </div>
					</div>
				</div>
				<div
					class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
					data-background="../assets/img/unsplash/kelompok-bg.jpg">
					<div class="absolute-bottom-left index-2">
						<div class="text-light p-5 pb-2">
							<div class="mb-5 pb-3">
								<h1 class="mb-2 display-4 font-weight-bold" id="greetings"></h1>
								<h5 class="font-weight-normal text-muted-transparent">Pangkalan Kerinci, Indonesia</h5>
							</div>
							Photo by <a class="text-light bb" target="_blank" href="">
								Us</a> on <a class="text-light bb" target="_blank" href="">Camera</a>
						</div>
					</div>
				</div>
			</div>
