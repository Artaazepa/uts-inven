...
{
    $menuNames = collect(['barang', 'bos', 'ruangan', 'pengguna', 'jadwal']); 
    ...
    // Periksa apakah permission sudah ada sebelum melakukan insert
    $mergedPermissions->each(function ($permission) {
